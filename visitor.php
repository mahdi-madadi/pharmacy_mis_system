...
<body class="w3-container-fluide" style="background-image:url('image/suspinision.jpg');">
    ...
    <div class="w3-sidebar w3-bar-block w3-border-right" style="display:none" id="mySidebar">
        ...
        <a href="index.php" class="w3-bar-item w3-green w3-button"><i class="fa fa-home"></i></a>
        ...
        <a href="developers.php" class="w3-bar-item w3-button">About Us</a>
    ...
    <div id="header" class="w3-light-gray w3-row" style="width:100%;">
        <div class="w3-quarter w3-section w3-mobile">
            <form id="search-form" method="post" action="index.php" onsubmit="clearTable()">
